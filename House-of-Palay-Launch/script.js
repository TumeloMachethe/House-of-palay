...
(() => {
  ...
  function openProductModal(id) {
    ...
    // Always open the mobile quick view at the product image. The details and
    // Size/ml/Colour selectors stay in normal document flow underneath it, so
    // the customer simply scrolls down instead of seeing controls over the photo.
    productModal.scrollTop = 0;
    requestAnimationFrame(() => { productModal.scrollTop = 0; });
  }
